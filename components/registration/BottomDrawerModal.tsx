  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      <div
        ...
        style={{
          height: isReturningUser ? 'min(92vh, 950px)' : 'min(88vh, 900px)',
      ...
      >
        ...
        <div className="bg-[#fafbfc] px-6 py-4 border-b border-gray-200">
          <h2
            id="drawer-title"
            className="text-2xl font-bold text-[#22224C] mb-2"
          >
          ...
          <div className="bg-[#C6E7FF] border border-[#0092FF]/20 rounded-lg px-4 py-3">
        ...
        {/* Welcome Back Banner */}
        {isReturningUser && (
          <div className="bg-green-50 border-l-4 border-green-500 px-6 py-2.5 animate-fade-in">
        ...
        {/* Footer */}
        <div className="absolute bottom-0 left-0 right-0 bg-[#fafbfc] border-t border-gray-200 px-6 py-4">
          <div className="flex flex-col-reverse md:flex-row gap-3 md:justify-end">
            <button
              type="button"
              onClick={onClose}
              className="px-6 py-2.5 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-200"
            >
              Cancel
            </button>
            <button
              ...
              className="px-6 py-2.5 bg-[#0092FF] text-white rounded-lg text-sm font-medium hover:bg-[#0082E6] disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors duration-200 flex items-center justify-center gap-2"
            >
              Start Video
              <svg
                className="w-4 h-4"
