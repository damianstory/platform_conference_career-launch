      ...
      >
        ...
        <td className="py-5 pr-4">
          <div className="flex flex-col gap-1.5">
            {session.isFeatured && (
              <span className="inline-flex items-center gap-1.5 w-fit px-2.5 py-0.5 bg-primary-blue text-white text-xs font-semibold uppercase tracking-wide rounded-full shadow-sm">
