      ...
      <table className="w-full">
        <thead className="border-b-2 border-white/20">
          <tr>
            ...
            <th className="text-left py-3 text-sm font-semibold text-white/90 w-36 hidden md:table-cell">
              Industry
            </th>
            <th className="text-left py-3 text-sm font-semibold text-white/90 w-24 hidden md:table-cell">
              Duration
            </th>
            <th className="text-left py-3 text-sm font-semibold text-white/90 w-32">
              Grade Level
            </th>
